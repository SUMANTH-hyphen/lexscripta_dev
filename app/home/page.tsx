...
const PageHome = () => {
  ...
  return (
    <div className=' relative max-h-screen max-w-screen '>
      ...
      <div className=' absolute top-1/3 flex flex-col gap-5 items-center justify-center text-center left-1/2 transform -translate-x-1/2 whitespace-nowrap lg:gap-10 lg:items-start lg:top-1/3 lg:left-[60%] lg:translate-x-0  '>
